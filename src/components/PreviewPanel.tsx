...
const PreviewPanel = ({thumbnail, isLoading, aspectRatio}: {thumbnail: IThumbnail, isLoading: boolean, aspectRatio: AspectRatio }): React.ReactElement => {
    ...
    <div className="relative mx-auto w-full max-w-2xl">
        <div className="relative overflow-hidden ${aspectClasses[aspectRation]}">
            {/* Loading State */}
            {isLoading && (
